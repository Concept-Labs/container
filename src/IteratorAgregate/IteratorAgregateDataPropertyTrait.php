<?php
namespace cl\Container\IteratorAgregate;

use Cl\Container\IteratorAgregate\Exception\InvalidArgumentException;
use Cl\Container\IteratorAgregate\Exception\InvalidPropertyException;
use Cl\Container\IteratorAgregate\Exception\PropertyNotInitializedException;
